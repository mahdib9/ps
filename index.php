...
$token = $textmessage ;
	...
	$ok = $resultb["ok"];
		...
		$source = str_replace("178815386",$from_id,$source);
		save("bots/$un/index.php",$source);	
		file_get_contents("https://api.telegram.org/bot".$token."/setwebhook?url=http://php-sh9.rhcloud.com/bots/$un/index.php");
